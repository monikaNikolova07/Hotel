...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=hotel_manager;Integrated Security=True;TrustServerCertificate=true");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Guest>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__guests__3213E83FE7B88D53");

            entity.ToTable("guests");

            entity.HasIndex(e => e.Ucn, "UQ__guests__C5B186D299A1E553").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__reservat__3213E83F23C68481");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__rooms__3213E83F5C3BBF68");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__room_typ__3213E83F22F6DA51");
